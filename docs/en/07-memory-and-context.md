...
**What this page covers**: how conversation history is stored, how it is progressively compressed as it grows, and how it is recalled.  
**After reading it you can**: locate problems with context bloat or lost memory, or modify the compression strategy.  
