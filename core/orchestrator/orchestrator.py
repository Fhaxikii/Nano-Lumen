...
class Orchestrator(McpMixin, ScreenMixin, FileToolsMixin, SubagentMixin, NotesAndTasksMixin, OsExecuteMixin, InteractionMixin, ReactLoopMixin, LongTaskMixin, OsSkillMixin, SkillWriterMixin, SkillLifecycleMixin, ToolDispatchMixin, PromptContextMixin):
